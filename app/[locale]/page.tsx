  ...
  return (
    <>
      <main className="h-[88vh] w-[100vw] flex flex-col overflow-hidden">
        <section
          className={`flex flex-col justify-around items-center w-[300px] h-[160px] mt-10 mb-10 text-[30px] pl-[140px] sm:mt-14 sm:h-[230px] sm:pl-[64px] sm:text-[46px] text-[#F8E7E7] font-bold mx-auto ${
