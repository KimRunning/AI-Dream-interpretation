  ...
  return (
    <>
      <section className="bg-black h-[56px] flex flex-row pl-1 lg:items-end w-[100%] justify-between">
        ...
        <div className="w-[56vw] flex mt-12 sm:hidden flex-row items-end justify-between pr-5 pb-[15px]">
          <Link href="/" passHref>
            <span className="text-[16px] font-bold 2xl:text-[22px]  text-[#D5C6ED] cursor-pointer">해몽하기</span>
          </Link>
          <Link href="/community" passHref>
            <span className="text-[16px] font-bold 2xl:text-[22px]  text-[#D5C6ED] cursor-pointer">꿈 게시판</span>
          </Link>
          <Link href="/inquire" passHref>
            <span className="text-[16px] font-bold 2xl:text-[22px]  text-[#D5C6ED] cursor-pointer">문의</span>
          </Link>
        </div>
