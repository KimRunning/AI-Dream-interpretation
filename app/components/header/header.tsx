...
export default function Header() {
  ...
  const { resetSearch, fetchDreams } = useSearch();
    ...
    <>
      <section className="bg-black h-[6vh] flex flex-row pl-1 lg:items-end w-[100%] justify-between">
        ...
        <div className="w-[50vw] flex mt-12 sm:hidden flex-row items-end justify-between pr-5 pb-[15px]">
          <Link href="/" passHref>
            <span onClick={() => handleLinkClick("/")} className="text-[18px] font-bold 2xl:text-[22px]  text-[#D5C6ED] cursor-pointer">
              해몽하기
            </span>
          </Link>
          <Link href="/community" passHref>
            <span onClick={() => handleLinkClick("/community")} className="text-[18px] font-bold 2xl:text-[22px]  text-[#D5C6ED] cursor-pointer">
              꿈 게시판
            </span>
          </Link>
          <Link href="/" passHref>
        ...
        <div className="hidden w-[350px] sm:flex flex-row justify-between items-end pr-2 lg:pr-10 pb-[6px] lg:w-[31vw]">
          <Link href="/" passHref>
            <span onClick={() => handleLinkClick("/")} className="font-bold 2xl:text-[24px] xl:text-[20px]  text-[#D5C6ED] cursor-pointer">
              꿈 해몽하기
            </span>
          </Link>
          <Link href="/community" passHref>
            <span onClick={() => handleLinkClick("/community")} className="font-bold 2xl:text-[24px] xl:text-[20px]  text-[#D5C6ED] cursor-pointer">
              꿈 게시판
            </span>
          </Link>
          <Link href="/inquire" passHref>
            <span onClick={() => handleLinkClick("/inquire")} className="font-bold 2xl:text-[24px] xl:text-[20px]  text-[#D5C6ED] cursor-pointer">
              제작자 / 문의
            </span>
          </Link>
        </div>
