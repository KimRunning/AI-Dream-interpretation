        ...
        <div className="z-50 w-[300px] h-[430px] sm:w-[430px] sm:h-[560px] bg-gradient-to-b from-[#733acf] to-[#312f33] flex flex-col items-center ">
          {onQuestion ? (
            <>
              ...
              <br />
              <div className="w-[270px] h-[180px] sm:w-[380px] sm:h-[245px] text-white overflow-y-scroll scrollbar-hide text-[18px]">{content[1]?.content}</div>
            </>
          ) : (
            <>
              <div className="w-[290px] font-bold sm:w-[420px] flex flex-row justify-between text-[15px] sm:text-[18px] text-white mt-1">
              ...
              <br />
              <div className="w-[270px] h-[180px] text-[18px] sm:w-[380px] sm:h-[245px] text-white overflow-y-scroll scrollbar-hide">{content[0]?.content}</div>
            </>
          )}
        </div>
      </section>
